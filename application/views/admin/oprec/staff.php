              ...
              <?php $this->load->view('admin/oprec/total_seleksistaff');?>
				<table class="table table-bordered table-striped table-vcenter js-dataTable-full">
					...
					<tr class="table-active">
						...
						<th class="text-center" style="width: 30%;"><b>Pencapaian</b></th>
						...
						<tr>
							...
							<td class="text-center">
								<form action="<?=base_url('Oprec/seleksi_wawancarastaff')?>" method="post">
									<div class="form-group">
										<input type="hidden" name="id_user" class="form-control" value="<?=$aslab['id_user']?>">
										<select class="form-control" name="seleksi_wawancarastaff" id="seleksi_wawancarastaff" required>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped table-vcenter js-dataTable-full">
								...
								<tr class="table-active">
									...
									<th class="text-center" style="width: 20%;"><b>Pencapaian</b></th>
