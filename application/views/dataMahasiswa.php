<div class="container">
    <a href="<?= base_url() ?>" class="btn btn-success mt-3"> Tambah Data</a>
            ...
            <tbody>
                ...
                foreach ($mahasiswa as $mhs) : ?>
                    <tr>
                        ...
                        <td><?= $mhs['alamat'] ?></td>
                        <td>
                            <a href="<?= base_url('Kontenweb/deleteData') ?>?id=<?= $mhs['id_mahasiswa'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('are you sure?')">Delete</a>
                            <button type="button" href="<?= base_url('Kontenweb/editData'); ?>" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editDataModal<?= $mhs['id_mahasiswa'] ?>">Edit</button>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
